            ...
            <div className="flex flex-col items-center w-full h-full my-24 p-4 md:p-12 justify-center text-justify">
                ...
                <div className="w-full md:w-[80%] h-full glassmorph p-12">
                    <p>
                        ...
                        Los datos personales que recoges <b>nombre, correo electrónico, teléfono</b> serán utilizados únicamente para responder a tus consultas o ofrecerte la información sobre mis servicios de dietética.
                        ...
                        Al enviar el formulario de contacto, aceptas que tus datos sean utilizados según lo indicado en esta política de privacidad.<br /><br />

                        Conservación de los datos:<br /><br />
